                        ...
                        <div class="favourites-cards">
                            <article>
                                <div class="favourites-img-card">
                                    <img src="{{ $cart->product->photo }}" alt="photo">
                                </div>
                                <div class="favourites-text-card">
                                    <div class="favourites-text-card-price">
                                        ...
                                        <div class="product-price">
                                            <div>
                                                <span>Цвет:</span>
                                                <span class="circle" style="background: {{ $cart->product->color }};"></span>
                                            </div>
                                            <div class="items">
                            ...
                            <div class="favourites-order">
                                <div class="favourites-price-sum">
                                    <p><span>Итог</span> &emsp; {{ $user_shopping_carts->first()->product->price }}₽</p>
                                </div>
                            </div>
                        @endforeach
...
B%D0%AC%D0%9D%D0%9E%D0%A1%D0%A2%D0%98.pdf">Политика
                ...
                <div class="footer-map">
                    ...
                    <a href="/">Карта безопасных мест</a>
